...
#ifndef FLUTTER_FACEBOOK_AUTH_SWIFT_H
#define FLUTTER_FACEBOOK_AUTH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_facebook_auth",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21flutter_facebook_auth30SwiftFlutterFacebookAuthPlugin")
@interface SwiftFlutterFacebookAuthPlugin : NSObject <FlutterPlugin>
