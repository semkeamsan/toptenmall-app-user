...
class ResetPasswordWidget extends StatefulWidget {
  ...
  const ResetPasswordWidget({Key key,@required this.mobileNumber,@required this.tmpToken}) : super(key: key);
  ...
  void resetPassword() async {
    ...
    //   _formKeyReset.currentState.save();
      ...
      if (_password.isEmpty) {
        ...
        Provider.of<AuthProvider>(context, listen: false).resetPassword(widget.mobileNumber,widget.tmpToken,_password, _confirmPassword).then((value) {
          if(value.isSuccess) {
