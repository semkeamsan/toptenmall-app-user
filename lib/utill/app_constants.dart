...
class AppConstants {
  static const String APP_NAME = 'KMOShop';

  static const String BASE_URL = 'http://toptenmall.eocambo.com';
  static const String REGISTER_VEDOR = BASE_URL + "/shop/apply";
  ...
  static const String UPLOAD_IMAGE_URI = '/api/v1/upload';
  ...
  static const String GET_PAYMENT_METHOD = '/api/v1/bank-info';
  static const String GET_SHIPPING_INFO = '/api/v1/shipping-method/detail/1';
  static const String CHECK_PHONE_URI = '/api/v1/auth/exist';
  static const String VERIFY_PHONE_URI = '/api/v1/auth/verify-token';
  ...
  static const String TOPIC = 'kmoshop';
